...
object AddCountryPartnerReceivedBenefitsPage extends BasePage with BooleanPage with OptionValues {

  override val url: String = "add-country-paid-partner-benefits"
