...
object AddCountryApplicantReceivedBenefitsPage extends BasePage with BooleanPage with OptionValues {

  override val url: String = "add-country-paid-you-benefits"
