...
final case class PreviousClaimantInternationalAddressPage(index: Int) extends BasePage {

  override val url: String = s"previous-claimant-international-address/$index"
