...
final case class PreviousGuardianInternationalAddressPage(index: Int) extends BasePage {

  override val url: String = s"person-child-lived-with-international-address/$index"
